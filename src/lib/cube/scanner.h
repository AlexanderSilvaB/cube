...
typedef enum {
  ...
  TOKEN_COMMA, TOKEN_DOT, TOKEN_EXPAND_IN, TOKEN_EXPAND_EX, TOKEN_MINUS, TOKEN_PLUS,
  ...
  TOKEN_TRUE, TOKEN_VAR, TOKEN_GLOBAL,
  TOKEN_WHILE, TOKEN_DO, TOKEN_IN, TOKEN_IS,
  TOKEN_CONTINUE, TOKEN_BREAK, TOKEN_SWITCH, TOKEN_CASE, TOKEN_DEFAULT,
  TOKEN_NAN, TOKEN_INF, TOKEN_ENUM,

  TOKEN_IMPORT, TOKEN_REQUIRE, TOKEN_AS, TOKEN_NATIVE, TOKEN_LET, TOKEN_WITH, 
  TOKEN_ASYNC, TOKEN_AWAIT, TOKEN_ABORT, TOKEN_TRY, TOKEN_CATCH,
