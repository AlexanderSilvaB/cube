...
#if !defined(_SSIZE_T_DEFINED) && !defined(_SSIZE_T_DEFINED_) && !defined(__DEFINED_ssize_t) &&                        \
    !defined(__ssize_t_defined) && !defined(_SSIZE_T) && !defined(_SSIZE_T_)
...
#define ZIP_DEFAULT_COMPRESSION_LEVEL 6
    ...
    extern int zip_entry_extract(struct zip_t *zip,
                                 size_t (*on_extract)(void *arg, unsigned long long offset, const void *data,
                                                      size_t size),
                                 void *arg);
